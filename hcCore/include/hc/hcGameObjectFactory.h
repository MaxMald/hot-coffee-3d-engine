...
namespace hc
{
  ...
  public:
    /**
     * @brief Constructs a GameObjectFactory with the given component factories
     * manager.
     * 
     * @param componentFactoriesManager Unique pointer to the component factories
     * manager.
     */
    GameObjectFactory(UniquePtr<ComponentFactoriesManager> componentFactoriesManager);
